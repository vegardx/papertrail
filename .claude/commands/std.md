Create an engineering standard (STD) document defining conventions, requirements, and best practices.
...
Argument: $ARGUMENTS (Topic or area to standardize, e.g., "GitHub Actions" or "TypeScript libraries")
