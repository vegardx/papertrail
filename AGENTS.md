...
The `scratchpad/` directory is gitignored and you are free to create and use it as needed. It can contain two subdirectories:

### `scratchpad/contexts/` - Read-Only Reference

This directory may contain cloned repositories from spec dependencies. If present, use it to:
...
Create and use this directory freely as a dumping ground for:
...
These files are gitignored and won't pollute the repository history.
