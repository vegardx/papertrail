---
name: validate
description: Validate cross-references and document integrity across all papertrail documents
agent: agent
argument-hint: Optional scope (e.g., "proposals", "specs", "all") - defaults to all
tools:
  - codebase
  - file
  - search
...
**Status:** {✅ All checks passed | ⚠️ Warnings found | ❌ Errors found}
